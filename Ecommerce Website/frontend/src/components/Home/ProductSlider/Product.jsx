...
const Product = (props) => {
  ...
  return (
    <>
      {type === "Auction" && ctime <= DTvalue ? (
        <div
          style={{
            background: "#cccccc",
            borderRadius: 10,
            boxShadow: "10px 10px 39px -10px rgba(0,0,0,0.75)",
          }}
          className="flex flex-col items-center gap-2 px-2 py-6 relative"
        >
          {/* <!-- image & product title --> */}
          <Link
            to={`/product/${_id}`}
          ...
          <div className="flex flex-col gap-2 items-center">
            ...
            <span className="text-sm text-gray-500 font-medium flex gap-2 items-center">
              <span className="text-xs px-1.5 py-0.5 bg-primary-green rounded-sm text-white flex items-center gap-0.5">
                Auction <StarIcon sx={{ fontSize: "14px" }} />
              </span>
            </span>
            {/* <!-- rating badge --> */}

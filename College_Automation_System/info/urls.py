...
from . import views
from .views import register, addFeedback, Clubs_Events
...
urlpatterns = [
    ...
    path('feedback/', views.register, name='register'),
    path('addFeedback/', views.addFeedback, name='addFeedback'),
    path('clubs_events/', views.Clubs_Events, name='clubs_events'),
    path('event/', views.register1, name='register1'),
